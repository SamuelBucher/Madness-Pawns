...
namespace Madness_Pawns
{
    ...
    public class Utility
    {
        ...
        {
            List<BodyTypeDef> bodyDefList = DefDatabase<BodyTypeDef>.AllDefsListForReading;

            if (LoadedModManager.GetMod<MadnessPawns>().GetSettings<Settings>().DefaultAdultBodyTypes)
            ...
            if (pawn.story.bodyType == BodyTypeDefOf.Child)
                if (LoadedModManager.GetMod<MadnessPawns>().GetSettings<Settings>().DefaultChildBodyType)
                    return BodyTypeDefOf.Child;
                else
                    return bodyDefList.Find(x => x.defName == "GruntChild");
            if (pawn.gender == Gender.Female && LoadedModManager.GetMod<MadnessPawns>().GetSettings<Settings>().FemaleBodyType)
            ...
            return bodyDefList.Find(x => x.defName == "Grunt");
           /* if (pawn.story.bodyType == BodyTypeDefOf.Baby)
                return BodyTypeDefOf.Baby;
            if (pawn.story.bodyType == BodyTypeDefOf.Child)
                if (LoadedModManager.GetMod<MadnessPawns>().GetSettings<Settings>().DefaultChildBodyType)
                    ...
                    return bodyDefList.Find(x => x.defName == "GruntChild");
            if (LoadedModManager.GetMod<MadnessPawns>().GetSettings<Settings>().DefaultBodyTypes)
                return pawn.story.bodyType;
            if (pawn.gender == Gender.Female && LoadedModManager.GetMod<MadnessPawns>().GetSettings<Settings>().FemaleBodyType)
                return BodyTypeDefOf.Female;
            if (LoadedModManager.GetMod<MadnessPawns>().GetSettings<Settings>().thinBodies)
